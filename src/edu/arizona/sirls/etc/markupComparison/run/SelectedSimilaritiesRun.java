...
public class SelectedSimilaritiesRun implements IRun {
	...
	@Inject
	public SelectedSimilaritiesRun(ITreatmentReader reader, 
	...
	public void run() {
		try {
			...
			int numberOfCalculations = size / 2;
			...
			for(int i=0; i<iterationList.size(); i=i+2) {
				TreatmentRoot a = iterationList.get(i);
				TreatmentRoot b = iterationList.get(i+1);
